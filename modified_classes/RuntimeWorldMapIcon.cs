...
public class RuntimeWorldMapIcon
{
	...
	{
		return (!this.Area.IsHidden(this.Position) || GameWorld.Instance.IconRevealed(this.Guid) || areaMap.DebugNavigation.UndiscoveredMapVisible) && Characters.Sein.PlayerAbilities.MapMarkers.HasAbility && (!this.IsSecret || Characters.Sein.PlayerAbilities.Sense.HasAbility);
	}
