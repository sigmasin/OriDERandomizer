...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['randomize_entrances'] = function(areas) {
		var $add225,$add231,$sub27,$add241,$sub28,firstDoors,doorStr,target,$add242,$add239,$and22,$and21,$and20,targets,$add230,group,$iter24_nextval,$iter24_array,$add243,$add222,$iter24_type,$add233,$add232,activeGroups,horuEntryGroup,$add219,$add218,$add235,$add234,$add215,$add214,$add217,$add216,$add211,$add210,match,$add212,$sub30,$add240,$sub29,$or13,index,$add228,outerDoors,$or12,$add236,$add202,lastDoorIndex,$add223,x,requirements,$iter24_iter,$and19,lastDoors,$add237,$add238,name,$add229,i,innerDoors,$add244,$iter24_idx,lines,$add199,$add220,$add221,$add208,$add209,$add224,$add213,$add226,$add227,y,$add203,$add200,$add201,$add206,$add207,$add204,$add205;
		...
		lastDoors['append'](innerDoors.__getitem__(12)['pop'](0));
		doorStr = '';
		activeGroups = $p['list']([0, 1, 2]);
		targets = $p['list']([3, 4, 5, 6, 7, 8, 9, 10, 12]);
		$m.random['shuffle'](targets);
		horuEntryGroup = $m.random['randint'](4, 10);
		if ($p['bool'](((($p['cmp'](horuEntryGroup, 7))|1) == 1))) {
			horuEntryGroup = $p['__op_add']($add219=horuEntryGroup,$add220=1);
		}
		if ($p['bool']($p['op_eq'](horuEntryGroup, 11))) {
			horuEntryGroup = 1;
			if ($p['bool'](($p['cmp']($m.random['random'](), 0.5) == 1))) {
				doorStr = $p['__op_add']($add221=doorStr,$add222=$m['connect_doors'](firstDoors.__getitem__(0), innerDoors.__getitem__(1)['pop'](0), areas));
				doorStr = $p['__op_add']($add223=doorStr,$add224=$m['connect_doors'](firstDoors.__getitem__(1), outerDoors.__getitem__(1)['pop'](0), areas));
			}
			else {
				doorStr = $p['__op_add']($add225=doorStr,$add226=$m['connect_doors'](firstDoors.__getitem__(0), outerDoors.__getitem__(1)['pop'](0), areas));
				doorStr = $p['__op_add']($add227=doorStr,$add228=$m['connect_doors'](firstDoors.__getitem__(1), innerDoors.__getitem__(1)['pop'](0), areas));
			}
		}
		else {
			...
			doorStr = $p['__op_add']($add229=doorStr,$add230=$m['connect_doors'](firstDoors.__getitem__(0), outerDoors.__getitem__(horuEntryGroup)['pop'](0), areas, requirements));
			doorStr = $p['__op_add']($add231=doorStr,$add232=$m['connect_doors'](firstDoors.__getitem__(1), innerDoors.__getitem__($p['__op_sub']($sub27=horuEntryGroup,$sub28=1))['pop'](0), areas));
		...
		while ($p['bool'](($p['cmp']($p['len'](targets), 0) == 1))) {
			...
			if ($p['bool'](($p['cmp'](target, 12) == -1))) {
				activeGroups['append']($p['__op_add']($add233=target,$add234=1));
			}
			...
			doorStr = $p['__op_add']($add235=doorStr,$add236=$m['connect_doors'](outerDoors.__getitem__(group)['pop'](0), innerDoors.__getitem__(target)['pop'](0), areas));
		}
		lastDoorIndex = 0;
		...
		while (typeof($p['__wrapped_next']($iter24_nextval).$nextval) != 'undefined') {
			...
			if ($p['bool'](innerDoors.__getitem__(group))) {
				doorStr = $p['__op_add']($add237=doorStr,$add238=$m['connect_doors'](innerDoors.__getitem__(group)['pop'](0), lastDoors.__getitem__(lastDoorIndex), areas));
				lastDoorIndex = $p['__op_add']($add239=lastDoorIndex,$add240=1);
			}
			if ($p['bool'](outerDoors.__getitem__(group))) {
				doorStr = $p['__op_add']($add241=doorStr,$add242=$m['connect_doors'](outerDoors.__getitem__(group)['pop'](0), lastDoors.__getitem__(lastDoorIndex), areas));
				lastDoorIndex = $p['__op_add']($add243=lastDoorIndex,$add244=1);
			}
		}
		return doorStr;
	};
	...
	$m['selectText'] = function(selectFrom, selectTo, line) {
		var $add251,$add250,$add252,$add245,$add246,$add247,$add248,$add249;
		return $m['re']['match']($p['__op_add']($add251=$p['__op_add']($add249=$p['__op_add']($add247=$p['__op_add']($add245='.*',$add246=selectFrom),$add248='(.*)'),$add250=selectTo),$add252='.*'), line)['group'](1);
	};
	...
	$m['placeItemsMulti'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, syncFlags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, balanced, entrance) {
		var $add264,$add265,$add266,$add260,$add261,$add262,$add263,$add259,$add258,$add253,$add255,$add254,$add257,$add256,playerFlags,placement,playerID,placements;
		placements = $p['list']([]);
		$m['sharedMap'] = $p['dict']([]);
		playerID = 1;
		playerFlags = flags;
		if ($p['bool'](syncFlags)) {
			playerFlags = $p['__op_add']($add257=$p['__op_add']($add255=$p['__op_add']($add253=flags,$add254=syncFlags),$add256='.'),$add258=$p['str'](playerID));
		}
		...
		while ($p['bool'](($p['cmp'](playerID, playerCountIn) == -1))) {
			playerID = $p['__op_add']($add259=playerID,$add260=1);
			if ($p['bool'](syncFlags)) {
				playerFlags = $p['__op_add']($add265=$p['__op_add']($add263=$p['__op_add']($add261=flags,$add262=syncFlags),$add264='.'),$add266=$p['str'](playerID));
			}
			placement = (typeof placeItems == "undefined"?$m.placeItems:placeItems)(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, playerFlags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, playerID, balanced, entrance);
			if ($p['bool'](!$p['bool'](placement))) {
				return $m['placeItemsMulti'](seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, syncFlags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, balanced, entrance);
	...
	$m['placeItems'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, playerIDIn, balancedIn, entrance, depth) {
		...
		if ($p['bool']($m['limitkeys'])) {
			...
			while ($p['bool'](!$p['bool'](satisfied))) {
				...
				if ($p['bool'](($p['bool']($and23=!$p['op_eq'](ginso, forlorn))?($p['bool']($and24=!$p['op_eq'](ginso, horu))?($p['bool']($and25=!$p['op_eq'](forlorn, horu))?($p['cmp']($p['__op_add']($add267=ginso,$add268=forlorn), 26) == -1):$and25):$and24):$and23))) {
					satisfied = true;
				}
			}
		...
		if ($p['bool'](noTeleporters)) {
			...
			$m['itemPool'].__setitem__('EX*', $p['__op_add']($add269=$m['itemPool'].__getitem__('EX*'),$add270=6));
		}
		...
		if ($p['bool'](($p['cmp']($m['playerID'], 1) == 1))) {
			...
			while (typeof($p['__wrapped_next']($iter25_nextval).$nextval) != 'undefined') {
				...
				$m['itemPool'].__setitem__('EX*', $p['__op_add']($add271=$m['itemPool'].__getitem__('EX*'),$add272=$m['itemPool'].__getitem__(item)));
		...
		while ($p['bool'](($p['cmp'](i, $p['len'](lines)) == -1))) {
			...
			if ($p['bool'](match)) {
				...
				i = $p['__op_add']($add273=i,$add274=1);
				continue;
			}
			match = $m['re']['match']('.*<Location>.*', lines.__getitem__(i));
			if ($p['bool'](match)) {
				loc = $m['Location']($p['float_int']($m['selectText']('<X>', '</X>', lines.__getitem__($p['__op_add']($add275=i,$add276=1)))), $p['float_int']($m['selectText']('<Y>', '</Y>', lines.__getitem__($p['__op_add']($add277=i,$add278=2)))), $p['getattr'](area, '$$name'), $m['selectText']('<Item>', '</Item>', lines.__getitem__($p['__op_add']($add279=i,$add280=3))), $p['float_int']($m['selectText']('<Difficulty>', '</Difficulty>', lines.__getitem__($p['__op_add']($add281=i,$add282=4)))), $m['selectText']('<Zone>', '</Zone>', lines.__getitem__($p['__op_add']($add283=i,$add284=5))));
				i = $p['__op_add']($add285=i,$add286=6);
				if ($p['bool'](!$p['bool'](includePlants))) {
			...
			if ($p['bool'](match)) {
				match2 = $m['re']['match']('.*<Entrance/>.*', lines.__getitem__($p['__op_add']($add287=i,$add288=1)));
				if ($p['bool'](match2)) {
					i = $p['__op_add']($add289=i,$add290=1);
					if ($p['bool'](entrance)) {
						continue;
					}
				}
				connection = $m['Connection']($m['selectText']('"', '"', lines.__getitem__($p['__op_add']($add291=i,$add292=1))), $m['selectText']('"', '"', lines.__getitem__($p['__op_add']($add293=i,$add294=2))));
				i = $p['__op_add']($add295=i,$add296=4);
				if ($p['bool'](!$p['bool'](includePlants))) {
			...
			i = $p['__op_add']($add303=i,$add304=1);
		}
		$m['outputStr'] = $p['__op_add']($add311=$m['outputStr'],$add312=$p['__op_add']($add309=$p['__op_add']($add307=$p['__op_add']($add305=flags,$add306='|'),$add308=$p['str'](seed)),$add310='\r\n'));
		if ($p['bool'](entrance)) {
			$m['outputStr'] = $p['__op_add']($add313=$m['outputStr'],$add314=$m['randomize_entrances']($m['areas']));
		}
		$m['outputStr'] = $p['__op_add']($add315=$m['outputStr'],$add316='-280256|EC|1|Glades\r\n');
		$m['outputStr'] = $p['__op_add']($add317=$m['outputStr'],$add318='-1680104|EX|100|Grove\r\n');
		$m['outputStr'] = $p['__op_add']($add319=$m['outputStr'],$add320='-12320248|EX|100|Forlorn\r\n');
		$m['outputStr'] = $p['__op_add']($add321=$m['outputStr'],$add322='-10440008|EX|100|Misty\r\n');
		if ($p['bool'](!$p['bool'](includePlants))) {
			$iter26_iter = plants;
			...
			while (typeof($p['__wrapped_next']($iter26_nextval).$nextval) != 'undefined') {
				...
				$m['outputStr'] = $p['__op_add']($add325=$m['outputStr'],$add326=$p['__op_add']($add323=$p['str'](location['get_key']()),$add324='|NO|0\r\n'));
			}
		}
		...
		while ($p['bool'](($p['bool']($or14=($p['cmp']($m['itemCount'], 0) == 1))?$or14:($p['bool']($and31=$m['balanced'])?$m['balanceListLeftovers']:$and31)))) {
			$m['balanceLevel'] = $p['__op_add']($add327=$m['balanceLevel'],$add328=1);
			opening = true;
			while ($p['bool'](opening)) {
				...
				keystoneCount = $p['__op_add']($add329=keystoneCount,$add330=keys);
				mapstoneCount = $p['__op_add']($add331=mapstoneCount,$add332=mapstones);
			...
			if ($p['bool'](($p['bool']($and33=!$p['bool']($m['doorQueue']))?!$p['bool']($m['mapQueue']):$and33))) {
				...
				if ($p['bool'](!$p['bool']($m['assignQueue']))) {
					if ($p['bool'](!$p['bool']($m['reservedLocations']))) {
						...
						return $m['placeItems'](seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, $m['playerCount'], $m['playerID'], $m['balanced'], entrance, $p['__op_add']($add333=depth,$add334=1));
					}
			...
			if ($p['bool'](($p['cmp']($p['len'](locationsToAssign), $p['__op_add']($add337=$p['__op_add']($add335=$p['len']($m['assignQueue']),$add336=$p['max']($p['__op_sub']($sub43=keystoneCount,$sub44=$m['inventory'].__getitem__('KS')), 0)),$add338=$p['max']($p['__op_sub']($sub45=mapstoneCount,$sub46=$m['inventory'].__getitem__('MS')), 0))) == -1))) {
				if ($p['bool'](!$p['bool']($m['reservedLocations']))) {
					if ($p['bool']($p['op_eq']($m['playerID'], 1))) {
						$m['sharedMap'] = $p['dict']([]);
					}
					...
					return $m['placeItems'](seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, $m['playerCount'], $m['playerID'], $m['balanced'], entrance, $p['__op_add']($add339=depth,$add340=1));
				}
				locationsToAssign['append']($m['reservedLocations']['pop'](0));
				locationsToAssign['append']($m['reservedLocations']['pop'](0));
			}
			...
			while (typeof($p['__wrapped_next']($iter29_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($m['assignQueue'])) {
					...
					$m['itemCount'] = $p['__op_add']($add341=$m['itemCount'],$add342=1);
				}
				else {
			...
			if ($p['bool'](spoilerPath)) {
				currentGroupSpoiler = $p['__op_add']($add347=currentGroupSpoiler,$add348=$p['__op_add']($add345=$p['__op_add']($add343='    Forced pickups: ',$add344=$p['str'](spoilerPath)),$add346='\r\n'));
			}
			...
			while (typeof($p['__wrapped_next']($iter32_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($m['spoilerGroup'].__contains__(skill))) {
					...
					while (typeof($p['__wrapped_next']($iter33_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add351=currentGroupSpoiler,$add352=$p['__op_add']($add349='    ',$add350=instance));
					}
					if ($p['bool'](seedDifficultyMap.__contains__(skill))) {
						$m['seedDifficulty'] = $p['__op_add']($add353=$m['seedDifficulty'],$add354=(typeof ($mul49=groupDepth)==typeof ($mul50=seedDifficultyMap.__getitem__(skill)) && typeof $mul49=='number'?
							$mul49*$mul50:
			...
			while (typeof($p['__wrapped_next']($iter34_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($m['spoilerGroup'].__contains__(event))) {
					...
					while (typeof($p['__wrapped_next']($iter35_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add357=currentGroupSpoiler,$add358=$p['__op_add']($add355='    ',$add356=instance));
					}
				}
			}
			...
			while (typeof($p['__wrapped_next']($iter36_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($p['op_eq']($p['__getslice'](key, 0, 2), 'TP'))) {
					...
					while (typeof($p['__wrapped_next']($iter37_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add361=currentGroupSpoiler,$add362=$p['__op_add']($add359='    ',$add360=instance));
					}
				}
			}
			...
			while (typeof($p['__wrapped_next']($iter38_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add365=currentGroupSpoiler,$add366=$p['__op_add']($add363='    ',$add364=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter39_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add369=currentGroupSpoiler,$add370=$p['__op_add']($add367='    ',$add368=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter40_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add373=currentGroupSpoiler,$add374=$p['__op_add']($add371='    ',$add372=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter41_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add377=currentGroupSpoiler,$add378=$p['__op_add']($add375='    ',$add376=instance));
			}
			if ($p['bool'](currentGroupSpoiler)) {
				groupDepth = $p['__op_add']($add379=groupDepth,$add380=1);
				$m['currentAreas']['sort']();
				spoilerStr = $p['__op_add']($add387=spoilerStr,$add388=$p['__op_add']($add385=$p['__op_add']($add383=$p['__op_add']($add381=$p['str'](groupDepth),$add382=': '),$add384=$p['str']($m['currentAreas'])),$add386=' {\r\n'));
				spoilerStr = $p['__op_add']($add389=spoilerStr,$add390=currentGroupSpoiler);
				spoilerStr = $p['__op_add']($add391=spoilerStr,$add392='}\r\n');
			}
			$m['currentAreas'] = $p['list']([]);
			...
			while (typeof($p['__wrapped_next']($iter42_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool'](!$m['areasReached'].__contains__($p['getattr']($m['doorQueue'].__getitem__(area), 'target')))) {
					...
					$m['seedDifficulty'] = $p['__op_add']($add393=$m['seedDifficulty'],$add394=(typeof ($mul51=difficulty)==typeof ($mul52=difficulty) && typeof $mul51=='number'?
						$mul51*$mul52:
			...
			while (typeof($p['__wrapped_next']($iter43_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool'](!$m['areasReached'].__contains__($p['getattr']($m['mapQueue'].__getitem__(area), 'target')))) {
					...
					$m['seedDifficulty'] = $p['__op_add']($add395=$m['seedDifficulty'],$add396=(typeof ($mul53=difficulty)==typeof ($mul54=difficulty) && typeof $mul53=='number'?
						$mul53*$mul54:
		...
		if ($p['bool']($m['balanced'])) {
			...
			while (typeof($p['__wrapped_next']($iter44_nextval).$nextval) != 'undefined') {
				...
				$m['outputStr'] = $p['__op_add']($add397=$m['outputStr'],$add398=item.__getitem__(2));
			}
		}
		spoilerStr = $p['__op_add']($add411=$p['__op_add']($add409=$p['__op_add']($add407=$p['__op_add']($add405=$p['__op_add']($add403=$p['__op_add']($add401=$p['__op_add']($add399=flags,$add400='|'),$add402=$p['str'](seed)),$add404='\r\n'),$add406='Difficulty Rating: '),$add408=$p['str']($m['seedDifficulty'])),$add410='\r\n'),$add412=spoilerStr);
		...
		while (typeof($p['__wrapped_next']($iter45_nextval).$nextval) != 'undefined') {
			...
			$m['outputStr'] = $p['__op_add']($add413=$m['outputStr'],$add414=event);
		}
	...
	$m['seed_hash'] = function(seed) {
		var index,$iter46_array,$sub50,$add416,$add415,$iter46_iter,$iter46_nextval,$sub49,value,$iter46_idx,$iter46_type;
		value = 0;
		...
		while (typeof($p['__wrapped_next']($iter46_nextval).$nextval) != 'undefined') {
			...
			value = $p['__op_add']($add415=$p['__op_sub']($sub49=(value)<<(5),$sub50=value),$add416=$p['ord'](seed.__getitem__(index)));
		}
	...
	$m['generate'] = function() {
		var includePlants,no_teleporters,zeroxp,$add426,$add427,$add424,$add425,$add422,$add423,$add420,$add421,$add428,$add429,hard,sync_id,$mod7,$mod8,playerCountIn,$add453,$add452,$add451,$add450,$add457,$add456,$add455,$add454,$add459,$add458,mode,clues,force_trees,shards,$add440,$add441,$add442,$add443,$add444,$add445,$add446,$add447,$add448,$add449,prefer_path_difficulty,non_progressive_mapstones,exp_pool,balanced,limitkeys,nobonus,entrance,$add419,$add418,$add417,$add468,$add462,$add463,$add460,$add461,$add466,$add467,$add464,$add465,sharedSeedFlags,seed,$add439,$add438,$add431,$add430,$add433,$add432,$add435,$add434,$add437,$add436,$mul58,modes,ohko,$mul57,$mul56,$mul55,flags,starved,syncFlags;
		...
		flags = '';
		syncFlags = '';
		flags = $p['__op_add']($add417=flags,$add418=mode);
		if ($p['bool'](limitkeys)) {
			flags = $p['__op_add']($add419=flags,$add420=',limitkeys');
		}
		if ($p['bool'](shards)) {
			flags = $p['__op_add']($add421=flags,$add422=',shards');
		}
		if ($p['bool'](clues)) {
			flags = $p['__op_add']($add423=flags,$add424=',clues');
		}
		if ($p['bool'](starved)) {
			flags = $p['__op_add']($add425=flags,$add426=',starved');
		}
		if ($p['bool'](prefer_path_difficulty)) {
			flags = $p['__op_add']($add429=flags,$add430=$p['__op_add']($add427=',prefer_path_difficulty=',$add428=prefer_path_difficulty));
		}
		if ($p['bool'](hard)) {
			flags = $p['__op_add']($add431=flags,$add432=',hard');
		}
		if ($p['bool'](ohko)) {
			flags = $p['__op_add']($add433=flags,$add434=',OHKO');
		}
		if ($p['bool'](zeroxp)) {
			flags = $p['__op_add']($add435=flags,$add436=',0XP');
		}
		if ($p['bool'](nobonus)) {
			flags = $p['__op_add']($add437=flags,$add438=',NoBonus');
		}
		if ($p['bool'](!$p['bool'](includePlants))) {
			flags = $p['__op_add']($add439=flags,$add440=',NoPlants');
		}
		if ($p['bool'](force_trees)) {
			flags = $p['__op_add']($add441=flags,$add442=',ForceTrees');
		}
		if ($p['bool'](non_progressive_mapstones)) {
			flags = $p['__op_add']($add443=flags,$add444=',NonProgressMapStones');
		}
		if ($p['bool'](no_teleporters)) {
			flags = $p['__op_add']($add445=flags,$add446=',NoTeleporters');
		}
		if ($p['bool'](balanced)) {
			flags = $p['__op_add']($add447=flags,$add448=',balanced');
		}
		if ($p['bool'](entrance)) {
			flags = $p['__op_add']($add449=flags,$add450=',entrance');
		}
		playerCountIn = 1;
		if ($p['bool']($m.enableSync['isChecked']())) {
			playerCountIn = $p['__op_add']($add451=$m.playerCountSelection['getSelectedIndex'](),$add452=1);
			...
			syncFlags = $p['__op_add']($add455=syncFlags,$add456=$p['__op_add']($add453=',shared=',$add454='+'['join'](sharedSeedFlags)));
			syncFlags = $p['__op_add']($add459=syncFlags,$add460=$p['__op_add']($add457=',mode=',$add458=$m.shareModeSelection['getItemText']($m.shareModeSelection['getSelectedIndex']())));
			...
			syncFlags = $p['__op_add']($add463=syncFlags,$add464=$p['__op_add']($add461=',sync',$add462=$p['str'](sync_id)));
		}
		$m.random['seed'](seed);
		...
		$m.genButton['setText']($p['__op_add']($add467=$p['__op_add']($add465='Seed ',$add466=seed),$add468=' generated. New seed?'));
	...
	$m['download_seed'] = function() {
		var dl,$mod10,$mod9,element,$add469,$add478,$add475,$add474,$add477,$add476,$add471,$add470,$add473,$add472;
		if ($p['bool']((typeof placements == "undefined"?$m.placements:placements))) {
			element = $m['DOM']['createElement']('a');
			element['setAttribute']('href', $p['__op_add']($add469='data:text/plain;charset=utf-8,',$add470=(typeof encodeURIComponent == "undefined"?$m.encodeURIComponent:encodeURIComponent)((typeof placements == "undefined"?$m.placements:placements).__getitem__($m['downloadPlayerID']).__getitem__(0))));
			...
			$m['downloadPlayerID'] = $p['__op_add']($add471=$m['downloadPlayerID'],$add472=1);
			...
			if ($p['bool'](($p['cmp']($p['len']((typeof placements == "undefined"?$m.placements:placements)), 1) == 1))) {
				$m['seedButton']['setText']($p['__op_add']($add477=$p['__op_add']($add475='Download Seed (P',$add476=$p['str']($p['__op_add']($add473=$m['downloadPlayerID'],$add474=1))),$add478=')'));
			}
		}
		return null;
	};
	...
	$m['download_spoiler'] = function() {
		var dl,$mod11,$mod12,element,$add484,$add485,$add486,$add487,$add479,$add481,$add482,$add483,$add480,$add488;
		if ($p['bool']((typeof placements == "undefined"?$m.placements:placements))) {
			element = $m['DOM']['createElement']('a');
			element['setAttribute']('href', $p['__op_add']($add479='data:text/plain;charset=utf-8,',$add480=(typeof encodeURIComponent == "undefined"?$m.encodeURIComponent:encodeURIComponent)((typeof placements == "undefined"?$m.placements:placements).__getitem__($m['downloadSpoilerID']).__getitem__(1))));
			...
			element['click']();
			$m['DOM']['removeChild'](dl, element);
			$m['downloadSpoilerID'] = $p['__op_add']($add481=$m['downloadSpoilerID'],$add482=1);
			...
			if ($p['bool'](($p['cmp']($p['len']((typeof placements == "undefined"?$m.placements:placements)), 1) == 1))) {
				$m['spoilerButton']['setText']($p['__op_add']($add487=$p['__op_add']($add485='Download Spoiler (P',$add486=$p['str']($p['__op_add']($add483=$m['downloadSpoilerID'],$add484=1))),$add488=')'));
			}
		}
		return null;
	};
	...
	$m['main'] = function() {
		...
		panel['add'](row4);
		panel['add'](row5);
		title = $pyjs_kwargs_call(null, $m['HTML'], null, null, [{StyleName:'title'}, 'Ori DE Randomizer (v2.4.1)']);
		row0['add'](title);
