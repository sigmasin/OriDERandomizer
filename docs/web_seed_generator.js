...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['placeItems'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, noTeleporters, doLocationAnalysis, doSkillOrderAnalysis, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones) {
		var $iter25_array,$sub29,satisfied,$iter26_idx,$iter27_idx,$iter29_array,$add189,$add188,currentConnection,mapstoneCount,keystoneCount,location,$add181,$add180,$add183,$add182,$add185,ginso,$add187,$add186,$sub31,$sub30,$sub33,$sub32,$sub35,$sub34,$sub37,$sub36,$sub39,$sub38,$iter28_iter,$add196,$add197,$add194,$add195,$add192,$add193,$add190,$add191,$iter28_nextval,$iter28_array,$add198,$add199,$add220,$add221,$add222,$add223,$add224,mode,$add226,$add227,$add228,$add229,$iter29_iter,$add178,$add179,$iter23_type,$iter25_nextval,$add170,$add171,$add172,$add173,$add174,$add175,$add176,$add177,horu,$or13,$iter26_array,$and20,item,forlorn,keys,$iter24_array,$add219,$add218,$add215,$add214,$add217,$add216,$add211,$add210,$add213,$add212,$add225,opening,$iter29_nextval,$iter24_iter,$iter23_nextval,$iter26_iter,$iter24_idx,$iter29_type,$add209,$add202,$add203,$add200,$add201,$add206,$add204,$add205,spoilerPath,$iter25_iter,loc,$iter28_type,locationsToAssign,area,$add230,mapstones,$add208,$iter27_iter,$iter23_array,plants,$add184,match,$iter27_type,$or12,$iter29_idx,$iter26_nextval,$iter28_idx,$add169,$iter23_idx,$sub40,$sub41,$sub42,itemsToAssign,difficultyMap,$iter23_iter,connection,$iter24_type,$iter26_type,$iter24_nextval,$iter25_idx,$iter27_nextval,$and12,$and13,$and11,$and16,$and17,$and14,$and15,$and18,$and19,$iter25_type,i,lines,limitKeysPool,$add207,$iter27_array;
		$m['shards'] = shardsMode;
		...
		if ($p['bool'](noTeleporters)) {
			...
			$m['itemPool'].__setitem__('EX*', $p['__op_add']($add171=$m['itemPool'].__getitem__('EX*'),$add172=6));
		}
	...
	$m['generate'] = function() {
		...
		if ($p['bool']($p['op_eq'](seed, ''))) {
			seed = $p['str']((4294967295)&((typeof ($mul35=$m['time']['time']())==typeof ($mul36=1000) && typeof $mul35=='number'?
				$mul35*$mul36:
