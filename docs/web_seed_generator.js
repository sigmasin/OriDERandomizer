...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['assign_to_location'] = function(item, location) {
		var $add134,$add127,$add89,$add88,$add129,$add131,$add116,$and9,$add83,$add117,$add114,$add115,$add87,$add86,$add85,$add84,$add133,$sub16,$add108,$sub18,$add121,$add128,$add105,$add123,$add113,$add104,$add100,$add118,zone,$add119,$add124,$add136,$add94,$add120,$sub17,$add95,$add137,$add110,$mul22,$mul21,$add101,$add103,$add102,$add98,$add99,$add107,$add106,assignment,$add96,$add97,$add90,$add91,$add92,$add93,$and10,$add111,$add138,$add126,$add140,$add130,$add135,value,$sub15,$add109,$add122,$add125,$add139,$add132,$add112;
		assignment = '';
		...
		assignment = $p['__op_add']($add137=assignment,$add138=$p['__op_add']($add135=$p['__op_add']($add133='|',$add134=zone),$add136='\r\n'));
	...
	$m['placeItems'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones) {
		var $sub27,$iter33_nextval,$iter40_array,$sub28,$sub29,satisfied,$iter26_idx,$iter32_iter,seedDifficultyMap,$iter37_nextval,skill,$add285,$add258,$add269,$iter34_iter,$add247,$iter33_type,$iter30_nextval,$iter26_type,$iter27_idx,$iter31_idx,$iter29_array,$add189,$add188,currentConnection,mapstoneCount,keystoneCount,location,$add235,$add234,$add181,$add180,$add183,$add185,ginso,match,$add186,$sub31,$sub30,$sub33,$add168,$sub35,$sub34,$sub37,$add163,$add162,$add161,$add167,$add166,$add165,$add164,$iter35_idx,$iter33_array,instance,$add262,$iter28_iter,$add263,$add196,$add197,$add194,$add195,$add192,$add193,$add190,$add191,$iter34_idx,$iter27_type,$iter28_nextval,$iter28_array,$add198,$add199,$add220,item,$add222,$add223,$add224,mode,$add226,$add227,$add228,$add229,$mul37,$iter37_iter,$add178,$add179,$sub32,$add281,$add286,$add287,$add284,$iter25_nextval,$add170,$add171,$add172,$add173,$add174,$add175,$add176,$add177,$mul41,horu,$iter26_array,$and20,event,$iter31_array,$iter39_type,$add221,$iter36_nextval,keys,$iter24_array,$add219,$add218,$add215,$add214,$add217,$add216,$add211,$add210,$add213,$add212,$add225,$iter30_type,$add279,opening,$iter35_nextval,$add276,$add275,$add274,$add273,$add272,$add271,$add270,difficulty,$iter29_nextval,$iter30_idx,key,$iter24_iter,$iter38_array,$add282,$iter39_idx,$iter38_type,$iter23_nextval,$iter26_iter,$iter24_idx,$iter30_iter,$add233,$iter37_idx,$iter37_type,$iter29_type,connection,$add209,$add278,$add202,$add203,$add200,$add201,$add206,spoilerStr,$add204,$add205,$iter39_nextval,spoilerPath,$iter32_idx,$iter40_iter,$add268,$iter37_array,$iter33_iter,$add264,$add265,$add266,$add267,$iter31_nextval,$iter23_type,$add245,$add244,$iter36_iter,$iter36_type,$iter40_type,$iter40_nextval,loc,$iter28_type,locationsToAssign,area,$add231,$add290,$iter40_idx,$add230,$mul39,$iter32_array,mapstones,$iter27_iter,$add288,$add236,$add259,$add237,$add260,$iter32_nextval,$iter36_idx,$add251,$add250,$add253,$add252,$add255,$add254,$add257,$add256,$iter23_array,$add289,$add239,plants,$add182,$add240,$iter29_iter,$add184,$iter34_array,$add248,$add187,$or13,$or12,currentGroupSpoiler,$iter29_idx,$add283,groupDepth,$add232,$iter38_iter,$iter25_array,$add280,$add241,$iter26_nextval,$iter28_idx,$add169,$iter38_idx,$add238,$iter23_idx,$iter25_iter,$sub40,$iter39_iter,itemsToAssign,difficultyMap,$iter30_array,$iter35_type,$iter23_iter,$iter31_type,$sub36,$mul40,$add208,$mul42,$iter24_type,$iter32_type,$sub39,$iter33_idx,$sub38,$add242,$iter36_array,$iter24_nextval,$iter25_idx,$iter27_nextval,$iter38_nextval,$mul38,$add277,$iter39_array,$and12,$and13,$and11,$and16,$and17,$and14,$and15,$add261,$iter35_array,$and18,$and19,$iter25_type,$iter34_nextval,$iter35_iter,i,lines,limitKeysPool,$add207,$add246,$iter27_array,$add243,forlorn,$add249,$iter34_type,$iter31_iter;
		$m['shards'] = shardsMode;
		...
		while ($p['bool'](($p['cmp']($m['itemCount'], 0) == 1))) {
			...
			if ($p['bool'](($p['cmp']($p['len'](locationsToAssign), $p['__op_add']($add219=$p['__op_add']($add217=$p['len']($m['assignQueue']),$add218=$p['max']($p['__op_sub']($sub35=keystoneCount,$sub36=$m['inventory'].__getitem__('KS')), 0)),$add220=$p['max']($p['__op_sub']($sub37=mapstoneCount,$sub38=$m['inventory'].__getitem__('MS')), 0))) == -1))) {
				if ($p['bool'](!$p['bool']($m['reservedLocations']))) {
					return $m['placeItems'](seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones);
				}
				locationsToAssign['append']($m['reservedLocations']['pop'](0));
			...
			if ($p['bool'](spoilerPath)) {
				currentGroupSpoiler = $p['__op_add']($add225=currentGroupSpoiler,$add226=$p['__op_add']($add223=$p['__op_add']($add221='    Forced pickups: ',$add222=$p['str'](spoilerPath)),$add224='\r\n'));
			}
			...
			while (typeof($p['__wrapped_next']($iter28_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($m['spoilerGroup'].__contains__(skill))) {
					...
					while (typeof($p['__wrapped_next']($iter29_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add229=currentGroupSpoiler,$add230=$p['__op_add']($add227='    ',$add228=instance));
					}
					if ($p['bool'](seedDifficultyMap.__contains__(skill))) {
						$m['seedDifficulty'] = $p['__op_add']($add231=$m['seedDifficulty'],$add232=(typeof ($mul37=groupDepth)==typeof ($mul38=seedDifficultyMap.__getitem__(skill)) && typeof $mul37=='number'?
							$mul37*$mul38:
			...
			while (typeof($p['__wrapped_next']($iter30_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($m['spoilerGroup'].__contains__(event))) {
					...
					while (typeof($p['__wrapped_next']($iter31_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add235=currentGroupSpoiler,$add236=$p['__op_add']($add233='    ',$add234=instance));
					}
				}
			}
			...
			while (typeof($p['__wrapped_next']($iter32_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($p['op_eq']($p['__getslice'](key, 0, 2), 'TP'))) {
					...
					while (typeof($p['__wrapped_next']($iter33_nextval).$nextval) != 'undefined') {
						...
						currentGroupSpoiler = $p['__op_add']($add239=currentGroupSpoiler,$add240=$p['__op_add']($add237='    ',$add238=instance));
					}
				}
			}
			...
			while (typeof($p['__wrapped_next']($iter34_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add243=currentGroupSpoiler,$add244=$p['__op_add']($add241='    ',$add242=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter35_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add247=currentGroupSpoiler,$add248=$p['__op_add']($add245='    ',$add246=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter36_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add251=currentGroupSpoiler,$add252=$p['__op_add']($add249='    ',$add250=instance));
			}
			...
			while (typeof($p['__wrapped_next']($iter37_nextval).$nextval) != 'undefined') {
				...
				currentGroupSpoiler = $p['__op_add']($add255=currentGroupSpoiler,$add256=$p['__op_add']($add253='    ',$add254=instance));
			}
			if ($p['bool'](currentGroupSpoiler)) {
				groupDepth = $p['__op_add']($add257=groupDepth,$add258=1);
				$m['currentAreas']['sort']();
				spoilerStr = $p['__op_add']($add265=spoilerStr,$add266=$p['__op_add']($add263=$p['__op_add']($add261=$p['__op_add']($add259=$p['str'](groupDepth),$add260=': '),$add262=$p['str']($m['currentAreas'])),$add264=' {\r\n'));
				spoilerStr = $p['__op_add']($add267=spoilerStr,$add268=currentGroupSpoiler);
				spoilerStr = $p['__op_add']($add269=spoilerStr,$add270='}\r\n');
			}
			...
			while (typeof($p['__wrapped_next']($iter38_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool'](!$m['areasReached'].__contains__($p['getattr']($m['doorQueue'].__getitem__(area), 'target')))) {
					...
					$m['seedDifficulty'] = $p['__op_add']($add271=$m['seedDifficulty'],$add272=(typeof ($mul39=difficulty)==typeof ($mul40=difficulty) && typeof $mul39=='number'?
						$mul39*$mul40:
			...
			while (typeof($p['__wrapped_next']($iter39_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool'](!$m['areasReached'].__contains__($p['getattr']($m['mapQueue'].__getitem__(area), 'target')))) {
					...
					$m['seedDifficulty'] = $p['__op_add']($add273=$m['seedDifficulty'],$add274=(typeof ($mul41=difficulty)==typeof ($mul42=difficulty) && typeof $mul41=='number'?
						$mul41*$mul42:
		...
		spoilerStr = $p['__op_add']($add287=$p['__op_add']($add285=$p['__op_add']($add283=$p['__op_add']($add281=$p['__op_add']($add279=$p['__op_add']($add277=$p['__op_add']($add275=flags,$add276='|'),$add278=$p['str'](seed)),$add280='\r\n'),$add282='Difficulty Rating: '),$add284=$p['str']($m['seedDifficulty'])),$add286='\r\n'),$add288=spoilerStr);
		...
		while (typeof($p['__wrapped_next']($iter40_nextval).$nextval) != 'undefined') {
			...
			$m['outputStr'] = $p['__op_add']($add289=$m['outputStr'],$add290=event);
		}
	...
	$m['seed_hash'] = function(seed) {
		var index,$iter41_array,$add292,value,$add291,$iter41_type,$iter41_nextval,$sub41,$iter41_iter,$iter41_idx,$sub42;
		value = 0;
		...
		while (typeof($p['__wrapped_next']($iter41_nextval).$nextval) != 'undefined') {
			...
			value = $p['__op_add']($add291=$p['__op_sub']($sub41=(value)<<(5),$sub42=value),$add292=$p['ord'](seed.__getitem__(index)));
		}
	...
	$m['generate'] = function() {
		...
		flags = '';
		flags = $p['__op_add']($add295=flags,$add296=$p['__op_add']($add293=mode,$add294=','));
		if ($p['bool'](limitkeys)) {
			flags = $p['__op_add']($add297=flags,$add298='limitkeys,');
		}
		if ($p['bool'](shards)) {
			flags = $p['__op_add']($add299=flags,$add300='shards,');
		}
		if ($p['bool'](clues)) {
			flags = $p['__op_add']($add301=flags,$add302='clues,');
		}
		if ($p['bool'](starved)) {
			flags = $p['__op_add']($add303=flags,$add304='starved,');
		}
		if ($p['bool'](prefer_path_difficulty)) {
			flags = $p['__op_add']($add309=flags,$add310=$p['__op_add']($add307=$p['__op_add']($add305='prefer_path_difficulty=',$add306=prefer_path_difficulty),$add308=','));
		}
		if ($p['bool'](hard)) {
			flags = $p['__op_add']($add311=flags,$add312='hard,');
		}
		if ($p['bool'](ohko)) {
			flags = $p['__op_add']($add313=flags,$add314='OHKO,');
		}
		if ($p['bool'](zeroxp)) {
			flags = $p['__op_add']($add315=flags,$add316='0XP,');
		}
		if ($p['bool'](nobonus)) {
			flags = $p['__op_add']($add317=flags,$add318='NoBonus,');
		}
		if ($p['bool'](!$p['bool'](includePlants))) {
			flags = $p['__op_add']($add319=flags,$add320='NoPlants,');
		}
		if ($p['bool'](force_trees)) {
			flags = $p['__op_add']($add321=flags,$add322='ForceTrees,');
		}
		if ($p['bool'](non_progressive_mapstones)) {
			flags = $p['__op_add']($add323=flags,$add324='NonProgressMapStones,');
		}
		if ($p['bool'](no_teleporters)) {
			flags = $p['__op_add']($add325=flags,$add326='NoTeleporters,');
		}
		...
		element['setAttribute']('href', $p['__op_add']($add327='data:text/plain;charset=utf-8,',$add328=(typeof encodeURIComponent == "undefined"?$m.encodeURIComponent:encodeURIComponent)(placement.__getitem__(1))));
		...
		element['click']();
		element['setAttribute']('href', $p['__op_add']($add329='data:text/plain;charset=utf-8,',$add330=(typeof encodeURIComponent == "undefined"?$m.encodeURIComponent:encodeURIComponent)(placement.__getitem__(0))));
	...
	$m['main'] = function() {
		var modeText,variations1,variations3,logicText,paths3,row1_2,row1_3,title,seedText,seedPanel,variationPanel,variations2,diffText,logicListener,paths2,pathsPanel,paths1,paths4,panel,row0,row1,row2,row3,row4,row1_1,variationText,customPathListener;
		...
		panel['add'](row3);
		panel['add'](row4);
		title = $pyjs_kwargs_call(null, $m['HTML'], null, null, [{StyleName:'title'}, 'Ori DE Randomizer (v2.1.0)']);
		row0['add'](title);
