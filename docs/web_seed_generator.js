...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['generate'] = function() {
		...
		element['setAttribute']('href', $p['__op_add']($add261='data:text/plain;charset=utf-8,',$add262=(typeof encodeURIComponent == "undefined"?$m.encodeURIComponent:encodeURIComponent)(placement.__getitem__(0))));
