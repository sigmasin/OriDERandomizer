...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['assign_random'] = function(recurseCount) {
		...
		var $iter20_nextval,$and9,$add80,$add78,$iter20_array,$div11,$div12,$and8,$iter20_iter,$or7,$or6,$or9,$or8,$and6,$and7,$and10,key,$add77,$iter20_type,value,$add79,$iter20_idx,position;
		...
		while (typeof($p['__wrapped_next']($iter20_nextval).$nextval) != 'undefined') {
			...
			if ($p['bool'](($p['cmp'](value, position) < 1))) {
				if ($p['bool'](($p['bool']($or6=($p['bool']($and6=(typeof starved == "undefined"?$m.starved:starved))?($p['bool']($and7=(typeof skillsOutput == "undefined"?$m.skillsOutput:skillsOutput).__contains__(key))?($p['cmp'](recurseCount, 3) == -1):$and7):$and6))?$or6:($p['bool']($and9=$m['inForlorn'])?($p['bool']($or8=$p['op_eq'](key, 'GumonSealShard'))?$or8:$p['op_eq'](key, 'ForlornKey')):$and9)))) {
	...
	$m['placeItems'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones) {
		...
		if ($p['bool']($m['limitkeys'])) {
			...
			while ($p['bool'](!$p['bool'](satisfied))) {
				...
				if ($p['bool'](($p['bool']($and13=!$p['op_eq'](ginso, forlorn))?($p['bool']($and14=!$p['op_eq'](ginso, horu))?($p['bool']($and15=!$p['op_eq'](forlorn, horu))?($p['cmp']($p['__op_add']($add161=ginso,$add162=forlorn), 26) == -1):$and15):$and14):$and13))) {
					satisfied = true;
				}
			}
		...
		while ($p['bool'](($p['cmp'](i, $p['len'](lines)) == -1))) {
			...
			if ($p['bool'](($p['bool']($and19=match)?currentConnection:$and19))) {
		...
		while ($p['bool'](($p['cmp']($m['itemCount'], 0) == 1))) {
			...
			if ($p['bool'](($p['bool']($and21=!$p['bool']($m['doorQueue']))?!$p['bool']($m['mapQueue']):$and21))) {
