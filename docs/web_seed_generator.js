...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['get_location_from_balance_list'] = function() {
		var target,$mul22,$div11,$div12,$mul21;
		...
		$m.balanceListLeftovers['append']((typeof balanceList == "undefined"?$m.balanceList:balanceList).__getitem__(target).__getitem__(0));
		return (typeof balanceList == "undefined"?$m.balanceList:balanceList).__getitem__(target).__getitem__(1);
	};
	...
	$m['placeItems'] = function(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, playerIDIn, balancedIn, depth) {
		...
		while ($p['bool'](($p['cmp']($m['itemCount'], 0) == 1))) {
			...
			if ($p['bool'](($p['bool']($and27=!$p['bool']($m['doorQueue']))?!$p['bool']($m['mapQueue']):$and27))) {
			...
			while (typeof($p['__wrapped_next']($iter28_nextval).$nextval) != 'undefined') {
				...
				else if ($p['bool'](($p['bool']($and29=$m['balanced'])?$p['op_eq']($m['itemCount'], 0):$and29))) {
	...
	$m['main'] = function() {
		...
		panel['add'](row4);
		panel['add'](row5);
		title = $pyjs_kwargs_call(null, $m['HTML'], null, null, [{StyleName:'title'}, 'Ori DE Randomizer (v2.2.0)']);
		row0['add'](title);
