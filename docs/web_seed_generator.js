...
$pyjs.loaded_modules['web_seed_generator'] = function (__mod_name__) {
	...
	$m['main'] = function() {
		...
		panel['add'](row4);
		panel['add'](row5);
		title = $pyjs_kwargs_call(null, $m['HTML'], null, null, [{StyleName:'title'}, 'Ori DE Randomizer (v2.6.0)']);
		row0['add'](title);
		...
		$m['modeSelection']['setSelectedIndex'](3);
		row1_2['add'](modeText);
		...
		$m['algSelection']['setSelectedIndex'](1);
